...
export class BrowseFiltersSheet extends LitElement {
    ...
    private _clearAll(): void {
        this._commit({ ...this._filters, category: new Set(), manufacturer: new Set(), localOnly: false });
    }
            ...
            <div class="filters-fab-wrap">
                <div class="container">
                    ...
                    >
                        ...
                        <span>Filters${count > 0 ? html`<span class="filters-fab-count"> · ${count}</span>` : nothing}</span>
                    </button>
                </div>
            </div>
        `;
                              ...
                              <header class="sheet-head">
                                  <div class="sheet-head-row">
                                      ${this._subView
                                          ...
                                          : html`<button class="sheet-back" aria-label="Close filters" @click=${this._close}>
                                  ...
                                  ${config
                                      ? html`${filters[config.dim].size > 0
                                                ...
                                                : html`<span class="modal-foot-meta"
                                                  ...
                                                  >`}
                                            <button class="btn btn-primary sheet-cta-inline" @click=${() => (this._subView = null)}>
                                                Save
                                            </button>`
